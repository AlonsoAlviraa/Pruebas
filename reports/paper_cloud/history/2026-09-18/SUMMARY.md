# Paper cloud multi-strategy — `2026-09-18`
...
| 5 | `S03_pullback` | `pullback` | -0.32% | -11.19% | 29.2% | 0.92 | 24 | 28 | no |
| 6 | `S07_pullback_long` | `combined_v2` | -0.67% | -11.54% | 28.6% | 0.60 | 14 | 18 | no |
| 7 | `S10_defensive_no_ext` | `no_extension` | -0.70% | -11.57% | 30.0% | 0.81 | 30 | 32 | no |
| 8 | `S05_topk_no_ext` | `no_extension` | -1.27% | -12.14% | 26.3% | 0.73 | 19 | 20 | no |
| 9 | `S04_qqq_gate` | `qqq_gate` | -1.30% | -12.18% | 33.3% | 0.75 | 39 | 42 | no |
| 10 | `S01_baseline_trend_mom` | `trend_mom` | -1.49% | -12.36% | 35.6% | 0.70 | 45 | 50 | no |
...
---
_Generated 2026-09-18T23:33:31.167254+00:00 · paper only_
